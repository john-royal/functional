/* eslint-disable */
// Generated by Wrangler by running `wrangler types web.d.ts --env web --env-interface WebEnv --config web.wrangler.jsonc --strict-vars=false` (hash: 46a29fadee87622bf2c475f864c26236)
// Runtime types generated with workerd@1.20250508.0 2025-05-01 nodejs_compat
...
interface WebEnv extends Cloudflare.Env {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_ISSUER" | "FRONTEND_URL" | "SESSION_SECRET">> {}
}
